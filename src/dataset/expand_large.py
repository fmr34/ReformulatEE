...
_NEW_DOMAINS = [
    ...
    ("sports science",               "athletic performance, biomechanics, exercise physiology, injury prevention"),
    ("nutrition science",            "dietary patterns, nutrient metabolism, bioavailability, intervention trials"),
    ...
    ("forensic science",             "evidence analysis, DNA profiling, toxicology, crime scene reconstruction"),
    ("demography",                   "population dynamics, fertility rates, migration, age structure"),
    ("development economics",        "poverty traps, microfinance, institutional capacity, growth determinants"),
    ("chemical engineering",         "reaction kinetics, process design, separation, catalysis"),
    ("biomedical engineering",       "implant design, biosensors, drug delivery systems, tissue scaffolds"),
    ...
    ("atmospheric science",          "aerosol dynamics, cloud microphysics, boundary layer, radiative forcing"),
    ...
    ("developmental psychology",     "cognitive milestones, attachment theory, language acquisition, adolescence"),
]
