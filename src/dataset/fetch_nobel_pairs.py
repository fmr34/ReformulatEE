...
_CURATED_MOTIVATIONS = [
    # Medicina / Fisiologia
    (1962, "medicine", "Francis Crick, James Watson, Maurice Wilkins",
    ...
    (1958, "medicine", "George Beadle, Edward Tatum",
    ...
    (2002, "medicine", "Sydney Brenner, John Sulston, Robert Horvitz",
    ...
    (1984, "medicine", "Niels Jerne, Georges Köhler, César Milstein",
    ...
    (2009, "medicine", "Elizabeth Blackburn, Carol Greider, Jack Szostak",
    ...
    (1976, "medicine", "Baruch Blumberg, Daniel Gajdusek",
    ...
    (1965, "physics", "Richard Feynman, Julian Schwinger, Sin-Itiro Tomonaga",
    ...
    (2001, "economics", "George Akerlof, Michael Spence, Joseph Stiglitz",
    ...
    (1979, "economics", "Theodore Schultz, Arthur Lewis",
    ...
    (2006, "medicine", "Andrew Fire, Craig Mello",
    ...
    (1944, "medicine", "Joseph Erlanger, Herbert Gasser",
    ...
    # Fisica adicional
    (1905, "physics", "Albert Einstein (special relativity)",
    ...
    (1974, "physics", "Antony Hewish, Martin Ryle",
    ...
    (2011, "physics", "Saul Perlmutter, Brian Schmidt, Adam Riess",
    ...
    # Quimica adicional
    (1962, "chemistry", "Max Perutz, John Kendrew",
    ...
    (1980, "chemistry", "Paul Berg, Walter Gilbert, Frederick Sanger",
    ...
    (2012, "medicine", "John Gurdon, Shinya Yamanaka",
    ...
    (2005, "medicine", "Barry Marshall, Robin Warren",
    ...
    (1988, "medicine", "James Black, Gertrude Elion, George Hitchings",
    ...
    # Economia adicional
    (1994, "economics", "John Nash, John Harsanyi, Reinhard Selten",
    ...
    (2013, "economics", "Eugene Fama, Lars Peter Hansen, Robert Shiller",
